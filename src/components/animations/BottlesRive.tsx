...
export default function RiveAnimation() {
  ...
  const { RiveComponent, rive } = useRive({
    ...
    src: "/animations/juice_bottles.riv",
  ...
  return (
    <div
      className="w-[300px] sm:w-[350px] md:w-[400px] lg:w-[50vw] h-[16vh] z-0 pointer-events-auto flex justify-center items-center opacity-[.1]"
